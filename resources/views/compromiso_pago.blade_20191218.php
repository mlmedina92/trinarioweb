			...
			<form id="form_compromiso_deuda" method="post">
				...
				<div class="row">
					<div class="col-md-3">
						<div class="form-group">
							...
							<input name="txtImporte" id="txtImporte" type="text" class="form-control" id="tags" placeholder="Tags" value="{!!$importe!!}" readonly="readonly" />
						</div>
					</div>
					<div class="col-md-3">
						<div class="form-group">
				...
				<div class="row">
					...
					<div class="col-md-3" id="id_elemento_anticipo" style="display:none">
						<div class="form-group">
							<input type="text" class="form-control" placeholder="Tags" value="<?php echo $importe_anticipo; ?>" name="txtImporteAnticipo" id="txtImporteAnticipo" readonly="readonly" />
						</div>
					</div>				
				</div>
