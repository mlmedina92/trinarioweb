					...
					<div class="col-md-12">
						<div class="row">				
							...
							<div class="col-md-3" style="margin-top: 7px">
								...
								<input type="hidden" name="txtOptTipoPagoOtros" value="<strong><label style='font-weight: bold; text-decoration-line:underline'>Instrucciones por Transferencia Bancaria:</label></strong><br>{!!$inst_transferencia_pago!!}">
							</div>
						</div>
					</div>
				</div>								
