				...
				<div class="row">
					...
					<div class="col-md-4" style="padding-right: 0px">
						<div class="form-group">
							...
							<!--<input type="text" id="txtCodigoRapiPago" name="txtCodigoRapiPago" class="form-control" id="tags" placeholder="Tags" value="1084889663" readonly="readonly" style="border-color: #29a22d; background-color:#29a22d;  border-width: 3px;color:#FFFFFF; font-weight: bold; text-align: center" />-->
							<!--<input type="text" id="txtCodigoRapiPago" name="txtCodigoRapiPago" class="form-control" id="tags" placeholder="Tags" value="1084889663" readonly="readonly" style="width: 80px" />-->
					...
					<div class="col-md-8" style="padding-right: 0px">
						<div class="form-group">
							...
							<!--<input type="text" id="txtCodigoPagoFacil" name="txtCodigoPagoFacil" class="form-control" id="tags" placeholder="Tags" value="197100000010000000001084889600072" readonly="readonly" style="width: 80px"   />-->
							...
							<!--<a href="javascript:void(0);" class="btn btn-default" rel="popover" data-placement="bottom" data-original-title="¿Como pagar?" data-content="PAGOFACIL: realizar el pago a nombre de CREDILOGROS, informando el DNI y el monto" style=""> <strong>197100000010000000001084889600072</strong></a>
							<a href="javascript:void(0);" class="btn btn-default txt-color-orange"><i class="fa fa-info-circle fa-lg"></i></a>-->
						</div>
					</div>
					</div>
				</div>
