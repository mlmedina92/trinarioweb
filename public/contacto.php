    ...
    <div id="content">
        <div class="col-left">
            ...
            <?php
                if($enviar=="send"){
            ?>
            <div class="<?php echo $class;?> txtcenter"><?php echo $mensaje;?></div>
            <?php
                }
            ?>
            <form action="contacto.php" method="post" id="frmContacto" name="frmContacto" class="frmcontact">
                ...
                <div class="ovh">
                    ...
                    <div class="col-right">
                        ...
                        <input type="text" name="txtTelefonoContacto" class="txtsmall">
                    </div>
                </div>
